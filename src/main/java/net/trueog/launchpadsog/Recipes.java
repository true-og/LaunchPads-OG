...
public class Recipes {
    ...
    private static final java.util.Vector<Component> loreList = new java.util.Vector<>();
    ...
    public static void addLauncherBase() {
        ...
        final ItemMeta baseMeta = launcherBase.getItemMeta();
        ...
        final NamespacedKey baseKey = new NamespacedKey(LaunchPadsOG.getPlugin(), "launcherBase");
        final ShapedRecipe baseRecipe = new ShapedRecipe(baseKey, launcherBase);
    ...
    public static void addLauncherLauncher() {
        ...
        final ItemMeta launchMeta = launcherLaunch.getItemMeta();
        ...
        final NamespacedKey armKey = new NamespacedKey(LaunchPadsOG.getPlugin(), "launcherArm");
        final ShapedRecipe armRecipe = new ShapedRecipe(armKey, launcherLaunch);
    ...
    public static void addLauncherExploder() {
        ...
        final ItemMeta exploderMeta = launcherExploder.getItemMeta();
        ...
        final NamespacedKey exploderKey = new NamespacedKey(LaunchPadsOG.getPlugin(), "launcherExploder");
        final ShapedRecipe exploderRecipe = new ShapedRecipe(exploderKey, launcherExploder);
    ...
    public static void addLauncherActivator() {
        ...
        final ItemMeta activatorMeta = launcherActivator.getItemMeta();
        ...
        final NamespacedKey activatorKey = new NamespacedKey(LaunchPadsOG.getPlugin(), "launcherActivator");
        final ShapedRecipe activatorRecipe = new ShapedRecipe(activatorKey, launcherActivator);
    ...
    public static void addLaunchPad() {
        ...
        final ItemStack launchPad = new ItemStack(Material.STONE_PRESSURE_PLATE);
        final ItemMeta padMeta = launchPad.getItemMeta();
        ...
        final NamespacedKey padKey = new NamespacedKey(LaunchPadsOG.getPlugin(), "launchPad");
        final ShapedRecipe padRecipe = new ShapedRecipe(padKey, launchPad);
