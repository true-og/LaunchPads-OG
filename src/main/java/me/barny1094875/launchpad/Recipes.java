...
public class Recipes {
    ...
    public static void addLauncherBase(){
        ...
        baseMeta.displayName(Component.text("Launcher Base")
        ...
        NamespacedKey baseKey = new NamespacedKey(LaunchPad.getPlugin(), "launcherBase");
    ...
    public static void addLauncherLauncher(){
        ...
        launchMeta.displayName(Component.text("Launcher")
                .decorate(TextDecoration.ITALIC));
        ...
        NamespacedKey armKey = new NamespacedKey(LaunchPad.getPlugin(), "launcherArm");
    ...
    public static void addLauncherExploder(){
        ...
        exploderMeta.displayName(Component.text("Launcher Exploder")
                .decorate(TextDecoration.ITALIC));
        ...
        NamespacedKey exploderKey = new NamespacedKey(LaunchPad.getPlugin(), "launcherExploder");
    ...
    public static void addLauncherActivator(){
        ...
        activatorMeta.displayName(Component.text("Launcher Activator")
                .decorate(TextDecoration.ITALIC));
        ...
        NamespacedKey activatorKey = new NamespacedKey(LaunchPad.getPlugin(), "launcherActivator");
    ...
    public static void addLaunchPad(){
        ...
        NamespacedKey padKey = new NamespacedKey(LaunchPad.getPlugin(), "launchPad");
